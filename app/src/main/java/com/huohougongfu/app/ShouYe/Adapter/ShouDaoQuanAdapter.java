...
public class ShouDaoQuanAdapter extends BaseQuickAdapter<LiBaoGson.ResultBean.ReceiveBean,BaseViewHolder> {
    public ShouDaoQuanAdapter(int layoutResId, @Nullable List<LiBaoGson.ResultBean.ReceiveBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, LiBaoGson.ResultBean.ReceiveBean item) {
        ...
        helper.setText(R.id.tv_quan_name,item.getCouponsLink().getSendNick()+"分享");
        helper.setText(R.id.tv_qiaoqoanhua,item.getCouponsLink().getPillowTalk());
    }
}
