...
public class SendKaQuanAdapter extends BaseQuickAdapter<ChaQuan.ResultBean.SendBean,BaseViewHolder> {
    public SendKaQuanAdapter(int layoutResId, @Nullable List<ChaQuan.ResultBean.SendBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ChaQuan.ResultBean.SendBean item) {
