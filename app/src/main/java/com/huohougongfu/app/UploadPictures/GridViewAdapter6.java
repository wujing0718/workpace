...
public class GridViewAdapter6 extends android.widget.BaseAdapter implements OnItemMovedListener {

    private Context mContext;
    private List<String> mList;
    private LayoutInflater inflater;

    public GridViewAdapter6(Context mContext, List<String> mList) {
    ...
    public int getCount() {
        ...
        if (count > MainConstant.MAX_SELECT_PIC_NUM_THREE) {
            return mList.size();
        } else {
            return count;
        }
