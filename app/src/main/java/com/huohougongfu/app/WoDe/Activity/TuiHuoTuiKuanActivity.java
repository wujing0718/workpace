...
public class TuiHuoTuiKuanActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView tv_shop_title,tv_shop_guige,tv_shop_num,tv_quxiao_yuanyin;
    private int id;
    ...
    private EditText edt_tuikuanshuoming,edt_kuaididanhao;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tui_huo_tui_kuan);
    ...
    private void initUI() {
        ...
        edt_tuikuanshuoming = findViewById(R.id.edt_tuikuanshuoming);
        edt_kuaididanhao = findViewById(R.id.edt_kuaididanhao);
        Glide.with(TuiHuoTuiKuanActivity.this).load(bean.getCoverUrl()).into(img_shop_photo);
    ...
    private void initTiJiao() {
        ...
        try {
            ...
            if (!edt_kuaididanhao.getText().toString().isEmpty()){
                jsonObject.put("expressNo",edt_kuaididanhao.getText().toString());
    ...
    private void initGridView(){
        ...
        mGridViewAddImgAdapter = new GridViewAdapter(TuiHuoTuiKuanActivity.this, mPicList);
    ...
    private void viewPluImg(int position) {
        Intent intent = new Intent(TuiHuoTuiKuanActivity.this, PlusImageActivity.class);
    ...
    private void refreshAdapter(List<LocalMedia> picList) {
        for (LocalMedia localMedia : picList) {
            ...
            if (localMedia.isCompressed()) {
                ...
                bitmap = PhotoUtils.getBitmapFromUri(uri,TuiHuoTuiKuanActivity.this);
            }
        }
    }
    ...
    private void initQuanXiao(String orderNo, int orderStatus) {
        new XPopup.Builder(TuiHuoTuiKuanActivity.this)
                .asCustom(new TuiKuanQuXiao(TuiHuoTuiKuanActivity.this,orderStatus,orderNo,mHandler))
                .show();
    }

    //
    private void initKuaDi() {
        new XPopup.Builder(TuiHuoTuiKuanActivity.this)
                .offsetY(300)
