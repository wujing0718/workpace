...
public class FenSiAdapter extends BaseQuickAdapter<ZhaoRenGson.ResultBean.ListBean,BaseViewHolder> {
    private List<ZhaoRenGson.ResultBean.ListBean> data1;
    public FenSiAdapter(int layoutResId, @Nullable List<ZhaoRenGson.ResultBean.ListBean> data) {
