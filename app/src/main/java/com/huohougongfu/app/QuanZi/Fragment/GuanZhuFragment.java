 ...
 */
public class GuanZhuFragment extends Fragment implements IListener {
    ...
    private int page = 2;
    private GuanZhuAdapter faXianAdapter;
    private String mId;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        inflate = inflater.inflate(R.layout.fragment_guan_zhu, container, false);
    ...
    private void initRec(GuanZhuDongTai faxian) {
        ...
        faXianAdapter = new GuanZhuAdapter(R.layout.item_quanzi_faxian,faxian.getResult().getList());
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                if (!token.isEmpty()){
                    if (faxian.getResult().getList().get(position).getType() == 2){
                        ...
                        intent.putExtra("userid",faxian.getResult().getList().get(position).getMember().getUserId());
                        intent.putExtra("关注视频",faxian.getResult().getList().get(position));
    ...
    //取消点赞
    private void initQuXiaoDianZan(String type, GuanZhuDongTai.ResultBean.ListBean listBean, ImageView img_faixan_shoucang, TextView tv_dianzan_num) {
        Map<String,String> map = new HashMap<>();
        map.put("type",type);
    ...
    //点赞
    private void initDianZan(String type, GuanZhuDongTai.ResultBean.ListBean listBean, ImageView img_faixan_shoucang, TextView tv_dianzan_num) {
        String num = tv_dianzan_num.getText().toString();
        Map<String,String> map = new HashMap<>();
        map.put("type",type);
        map.put("dataId",String.valueOf(listBean.getId()));
        ...
        OkGo.<String>post(Contacts.URl1+"/circle/attention/dynamic")
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        String body = response.body();
                        Gson gson = new Gson();
                        GuanZhuDongTai faxian = gson.fromJson(body, GuanZhuDongTai.class);
                        if (faxian.getResult().getList().size()>0){
