...
-keep public class [com.huohougongfu.app].R$*{
public static final int *;
}
...
-keepclassmembers class * {
   public <init> (org.json.JSONObject);
    ...
    #--------实体类(实体Model不能混淆，否则找不到对应的属性获取不到值)------

    -dontwarn com.huohougongfu.app.Gson.**
    #对含有反射类的处理
    -keep class com.huohougongfu.app.Gson.** { *; }
    ...
    -keep interface android.net.compatibility.**{*;}
    ...
    # 腾讯X5
    #-keep com.tencent.smtt.sdk.WebSettings;
    #-keep com.tencent.smtt.sdk.WebView;
    #-keep com.tencent.smtt.sdk.WebViewClient
    -dontwarn com.tencent.smtt.**
